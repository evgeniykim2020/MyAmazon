...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    private StorageReference productImaegRef;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        productImaegRef = FirebaseStorage.getInstance().getReference().child("Product Images");
    ...
    private void StoreProductInformation()
    {
        ...
        final StorageReference filePath = productImaegRef.child(imageUri.getLastPathSegment() + productRandomKey + ".jpg");
